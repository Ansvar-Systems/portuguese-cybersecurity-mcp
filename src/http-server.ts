      ...
      switch (name) {
        ...
        case "pt_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "CNCS (Centro Nacional de Ciberseguranca — National Cybersecurity Centre of Portugal) MCP server. Provides access to Portuguese national cybersecurity guidelines, NIS2 implementation materials, and security advisories.",
