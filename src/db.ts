/**
 * SQLite database access layer for the Portuguese Cybersecurity (CNCS) MCP server.
 *
 * Schema:
 *   - guidance    — CNCS guidelines, technical reports, and standards (TR, IT-Grundschutz, BSI-Standard)
